...
REVIEW_ASK = (
    "Как прошла игра? Оцени от 1 до 5 ⭐\n\n{game}"
)
REVIEW_ASK_COMMENT = (
    "Спасибо! Хочешь добавить пару слов? Их увидит организатор.\n"
    "Не хочешь — жми «Без комментария»."
)
REVIEW_THANKS = "Спасибо за отзыв 🙌"
REVIEW_ALREADY = "Ты уже оценил эту игру"
REVIEW_GAME_GONE = "Эта игра больше недоступна"
REVIEW_BAD_COMMENT = "Слишком длинно. Уложись в {limit} символов:"
REVIEW_FOR_ORGANIZER = (
    "⭐ <b>Отзыв о твоей игре</b>\n\n"
    "{game}\n\n"
    "{stars} от {author}{comment}"
)

# --- админская команда /reviews ---
REVIEWS_HEADER = "⭐ <b>Отзывы</b> (последние {count})"
REVIEWS_GAME_HEADER = "⭐ <b>Отзывы об игре #{game_id}</b> — средняя {average}"
REVIEWS_EMPTY = "Отзывов пока нет."
REVIEWS_GAME_EMPTY = "Об этой игре ещё никто не написал."

# --- строка в общей статистике ---
STATS_RATING = "⭐ <b>Средняя оценка игр:</b> {average} ({count})"
...
ADMIN_HELP = (
    ...
    "/reviews — свежие отзывы об играх\n"
    "/reviews 12 — отзывы об игре №12\n\n"
...
def stars(rating: int) -> str:
    """3 -> '⭐⭐⭐☆☆' — оценка наглядно."""
    full = max(0, min(5, int(rating or 0)))
    return "⭐" * full + "☆" * (5 - full)
